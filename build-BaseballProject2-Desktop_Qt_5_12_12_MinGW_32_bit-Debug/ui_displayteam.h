...
"text-decoration: underline;"));
        widget = new QWidget(displayTeam);
        widget->setObjectName(QString::fromUtf8("widget"));
        widget->setGeometry(QRect(120, 10, 651, 511));
    ...
    void retranslateUi(QDialog *displayTeam)
    {
        ...
        pushButton->setText(QApplication::translate("displayTeam", "Display all information", nullptr));
