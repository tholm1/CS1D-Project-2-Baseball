...
struct qt_meta_stringdata_CLASSModifyStadiumsENDCLASS_t {};
static constexpr auto qt_meta_stringdata_CLASSModifyStadiumsENDCLASS = QtMocHelpers::stringData(
    "ModifyStadiums",
    "on_delBtn_clicked",
    "",
    "on_backBtn_clicked",
...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_CLASSModifyStadiumsENDCLASS_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_CLASSModifyStadiumsENDCLASS_t qt_meta_stringdata_CLASSModifyStadiumsENDCLASS = {
    {
...
Q_CONSTINIT static const uint qt_meta_data_CLASSModifyStadiumsENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject ModifyStadiums::staticMetaObject = { {
    ...
    qt_meta_stringdata_CLASSModifyStadiumsENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSModifyStadiumsENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSModifyStadiumsENDCLASS_t,
        // Q_OBJECT / Q_GADGET
...
void *ModifyStadiums::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CLASSModifyStadiumsENDCLASS.stringdata0))
